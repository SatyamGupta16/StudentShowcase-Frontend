                                ...
                                <div className="p-6">
                                    ...
                                    <div className="mt-5 rounded-2xl bg-slate-50 p-4">
                                        ...
                                        <div className="flex items-center gap-3">
                                            {project.student?.profilePhoto ? (
                                                <img
                                                    src={getProjectImageUrl(project.student.profilePhoto)}
                                                ...
                                                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-purple-100 text-lg font-bold text-purple-600">
                                                    {project.student?.name?.charAt(0)?.toUpperCase() || "S"}
                                                </div>
                                            )}
                                    ...
                                    <div className="mt-6 flex flex-wrap gap-3">
                                        ...
                                        {project.student?._id && (
                                            <button
                                                onClick={() =>
                                                    router.push(`/showcase/students/${project.student._id}`)
                                                }
